...

{
  ...
  disko.tests.extraChecks = ''
    ...
    machine.succeed("test \"$(zfs list -H -o name | sort | tr '\\n' ' ')\" = \"tank tank/disposable tank/disposable/cache tank/disposable/downloads tank/disposable/jellyfin tank/disposable/media tank/disposable/models tank/disposable/temp tank/services tank/shared tank/users tank/users/alex tank/users/alex/apps tank/users/alex/home tank/users/andreea tank/users/andreea/apps tank/users/andreea/home \"")
